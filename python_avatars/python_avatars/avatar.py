...
class Avatar:
    ...
    def __init__(
        ...
        self.shirt_text_color = text_color
        ...
        if not self.__is_empty(self.clothing):
            ...
            if self.clothing == ClothingType.GRAPHIC_SHIRT and not self.__is_empty(self.shirt_graphic):
                ...
                if self.shirt_graphic == ClothingGraphic.CUSTOM_TEXT:
                    graphicText = graphic.get_element_by_id(
                        'Graphic-Text'
                    )
                    graphicText.children('tspan')[0].set_content(self.shirt_text)
                    graphicText.set_attr('fill', self.shirt_text_color)
